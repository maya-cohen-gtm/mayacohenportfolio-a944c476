...
export const projects: Project[] = [
  ...
  },
  {
    ...
    outcome: "80%+ adoption of the enterprise collaboration channel across 3,000+ employees and over 50% of data center strategic priorities delivered, supporting a program that scaled from $11B to $40B.",
    ...
    sections: [
      ...
      { label: "My Role", content: "I built and ran the business communications program behind the transformation — the operating system that kept a global workforce, studio leadership, and infrastructure teams telling the same story.", items: [
        ...
        "Delivered executive communications and operations support as the program scaled from $11B to $40B, unifying tools and resources and resolving cross-functional workflow gaps across Marketing.",
      ]},
      { label: "Impact", content: "Reached 3,000+ employees across a global studio with a single, consistent business narrative: 22,000+ newsletter downloads, 80%+ adoption of the enterprise social collaboration channel, and 70+ modernized corporate web pages. The first crowdsourcing campaign returned 3x the industry average in actionable ideas. The OKR program drove over 50% of infrastructure data center strategic priorities, supporting a program that scaled from $11B to $40B." },
